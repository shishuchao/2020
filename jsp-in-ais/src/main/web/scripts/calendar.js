...
function writeIframe()
{
    ...
    "</style><SCRIPT LANGUAGE='javascript'>function killErrors() {return true;}window.onerror = killErrors;</SCRIPT></head><body onselectstart='return false' style='margin: 0px' oncontextmenu='return false'><form name=meizz>";
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
         ...
         " type=button value='清空' onclick='parent.clearDate()'>&nbsp"+
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "#47bcff";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#a0ffcd";    //控件的按钮背景色
    this.wordColor  = "#000040";    //控件的文字颜色
    this.wordDark   = "#DCDCDC";    //控件的暗文字颜色
    this.dayBgColor = "#cdffe1";    //日期数字背景色
    this.todayColor = "#336dff";    //今天在日历上的标示背景色
