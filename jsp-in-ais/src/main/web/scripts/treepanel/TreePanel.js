...
TreePanel.prototype={
	initialize : function(config){
		...
		var showSelectBox = config['showSelectBox'];
		if(Boolean.isInstance(showSelectBox)){
...
TreeNode.prototype={
	initEl : function(){
		...
		if(!ownerTree.isShowSelectBox() || this.checked===false){
	...
	paintClipIcoImg : function(){
		if(this.isRoot()){
			this['html-element']['clip'].style.display='none';//涓嶆樉绀烘牴鑺傜偣鐨刢lip
			return;
		}
		var ownerTree = this.getOwnerTree();
		var icon = 'empty';
