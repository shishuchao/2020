...
<div style="margin: 0;padding: 0;overflow:hidden;" class="easyui-layout" fit="true">
	...
	<div id="templateWindow" title="模板列表" style="overflow:hidden;padding:0px">
...
<script type="text/javascript">
	$(function(){
		...
		$('#projectTypeList').datagrid({
			url : "<%=request.getContextPath()%>/unitary/nc/autoreport/evaluationProjectTypeList.action",
			method:'post',
			cache:false,
			showFooter:false,
			rownumbers:true,
			...
			columns:[[
				...
				{field:'operate',
					...
					formatter:function(value,row,index){
						var link = '<a href=\"javascript:void(0);\" onclick=\"templateList(\''+row.code+'\',\'evaluationReport\')\">模板列表</a>';
						return link;
					}
				}
			]]
