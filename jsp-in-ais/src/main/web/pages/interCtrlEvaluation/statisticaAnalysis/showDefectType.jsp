...
<script type="text/javascript">
    ...
    function doSearch(){
        ...
        if(year == null||evaDeptCode == null||evaDeptCode===''){
            ...
            $('#chartFrame').attr('src',"${contextPath}/pages/interCtrlEvaluation/statisticaAnalysis/lineChart.jsp?from=byType&evaluateYear="+year+"&evaDeptCode="+evaDeptCode);
        }
    }
...
<body style='padding:0px;margin:0px;overflow:hidden;'  border='0' fit='true' class='easyui-layout'>
	...
	<div region='center'  style='padding:0px;height:500px;margin:0px;overflow:auto;' title='统计图'>
		<iframe id="chartFrame" width="100%" height="500px" src="/ais/pages/interCtrlEvaluation/statisticaAnalysis/lineChart.jsp?from=byType" frameborder="0"></iframe>
	</div>	
	<div region='south'  style='padding:0px;margin:0px;height:200px;overflow:auto;' title='内部控制评价缺陷统计汇总表'>
		<table  class="table table-striped" id="typeTable" style="width:100%;border-collapse:collapse;" >
			<thead>					
				    <tr> 
				      <th   class="EditHead" style="width:25%;text-align:center">业务流程</th>
				      <th  class="EditHead" style="width:25%;text-align:center">设计缺陷</th>
				      <th  class="EditHead" style="width:25%;text-align:center">运行缺陷</th>
