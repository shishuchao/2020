...
if(_2f8=="west"){
return {resizeC:{width:_2fa.center.panel("options").width+_2fa["west"].panel("options").width-24,left:24},expand:{left:0},expandP:{left:0,top:_2fa["west"].panel("options").top,width:24,height:_2fa["center"].panel("options").height},collapse:{left:-_2fa["west"].panel("options").width}};
}else{
if(_2f8=="north"){
var hh=cc.height()-28;
