		...
		<table cellpadding=0 cellspacing=1 border=0 bgcolor="#409cce"
			...
			<tr class="listtablehead">
				<td  align="left" class="edithead">
						<s:property
						escape="false" value="@ais.framework.util.NavigationUtil@getNavigation('/ais/report/formula/index.action')" />
				</td>
			</tr>
		</table>
<div id="container">
  <div id="content">
	...
	src="<s:url action="typeTree" namespace="/report/formula"></s:url>"></iframe>
  </div>
  <div id="sidebar">
