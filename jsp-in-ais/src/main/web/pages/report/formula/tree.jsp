...
<head>
	...
	Ext.QuickTips.init();
	 ...
	 var node_1=new Tree.TreeNode({
         id:'1',
         text:'系统公式',
         href:'${contextPath}/report/formula/list.action?typeCode=1&attributeCode=1',
         hrefTarget:'childBasefrm',
         draggable:false //不允许拖拽
	  });
	  ...
	  var node_2=new Tree.TreeNode({
         id:'2',
         text:'区域公式',
         href:'${contextPath}/report/formula/list.action?typeCode=2&attributeCode=2',
         hrefTarget:'childBasefrm',
         draggable:false //不允许拖拽
	  });
	  ...
	  var node_3=new Tree.TreeNode({
         id:'3',
         text:'单元格公式',
         href:'${contextPath}/report/formula/list.action?typeCode=3&attributeCode=3',
         hrefTarget:'childBasefrm',
         draggable:false //不允许拖拽
	  });
	  node_0.appendChild(node_3);	  
     <s:iterator value="result">
      	var node_${typeCode}=new Tree.TreeNode({id:'${id}',qtip:'${typeName}',text:'${typeName}',href:'${contextPath}/report/formula/list.action?typeCode=${typeCode}&attributeCode=${attributeCode}',leaf:false,hrefTarget:'childBasefrm'});
	</s:iterator>
	<s:iterator value="result">
