...
<head>
	...
	<title>
		${condition.reportCode }
	</title>
	<s:include value="auditCellScript.jsp"></s:include>
	...
	<script type="text/javascript">
		...
		function fetchXMLData(){
			<s:if test="${not empty(condition.adjustReport)}">
...
<s:include value="auditCellToolMenu.jsp"></s:include>
