...
<script language="javascript">
			...
			function CheckSubmit(){
				...
				document.forms[0].action = "auditProblemChartAction!inStep.action";
	...
	<table id="tab1" cellpadding=0 cellspacing=0 border=0 align="center" class="ListTable" >
		<tr>
			...
			<td align="left" class="editTd">
				...
				--
				 <input type="text" id="endDate" name="endDate" editable="false"  Class="easyui-datebox noborder" />
			</td>
		</tr>
		<tr>
...
<table class="its" width="100%">
	<tr>
		<td><iframe allowtransparency="true" align="center" name="showreport" src="<%=request.getContextPath()%>/blank.jsp"
