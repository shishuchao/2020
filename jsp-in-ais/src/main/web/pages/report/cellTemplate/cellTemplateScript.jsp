...
<SCRIPT ID=clientEventHandlersVBS LANGUAGE=vbscript src="<%=request.getContextPath()%>/pages/report/cellTemplate/menuItemClick.vbs"></SCRIPT>
...
function window_onload() {
	...
	<%
	 ...
	 %>
	Menu1.ReadMenuFromRemoteFile("<%=menuServerPath2%>/pages/report/cellTemplate/emenu.clm");
