...
<body style="overflow:auto;"  >
    <div style="position:fixed;width: 100%;background-color:#FFFFFF;top: 0px;">
        <table cellpadding=0 cellspacing=0 class="ListTable_change" align="center">
            <colgroup>
                <col style="width: 15%;" />
                <col style="width: 15%;" />
                <col style="width: 15%;" />
            ...
            <thead>
                <tr>
                    ...
                    <td style="text-align: center;" class="EditHead">阶段性文书</td>
                    <td style="text-align: center;" class="EditHead fileOperate">操作</td>
                </tr>
            </thead>
        </table>
    </div>
    <div style="width:100%;margin-top: 30px; ">
        <s:form id="projectReworkForm" action="save" namespace="/project/rework"><s:hidden name="projectid" value="${projectid}" />
            <table id="workprogramdetailTable" cellpadding=0 cellspacing=0 class="ListTable_change" align="center">
                <colgroup>
                    <col style="width: 15%;" />
                    <col style="width: 15%;" />
                    <col style="width: 15%;" />
                        ...
                        <tr>
                            ...
                            <c:choose>
                                <c:when test="${empty projstage.wppdList}">
                                    ...
                                    <td style="text-align: left;" class="EditHead">&nbsp;</td>
                                    <td style="text-align: left;" class="EditHead">&nbsp;</td>
                                    <td style="text-align: left;" class="EditHead fileOperate">&nbsp;</td>
                                </c:when>
                                <c:otherwise>
                                    <c:forEach items="${projstage.wppdList}" var="wppd" begin="0" end="0">
                                        ...
                                        <td class="editTd fileOperate" style="text-align: center;">
                                            <c:if test="${view != 'view' }">
	...
	$(function(){
		...
		if('${uploadIdStrs}'!=null && '${uploadIdStrs}'!='' && '${uploadIdStrs}'!='null'){
			...
			"${view}" == 'true' ? $('.fileOperate').remove() : null;
		}
	});	
	</script>
