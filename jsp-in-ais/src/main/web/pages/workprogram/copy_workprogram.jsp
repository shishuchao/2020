...
<html>
	...
	<body style="overflow:hidden">
		...
		<s:form id="workprogramForm" action="saveWorkProgram4copy" namespace="/workprogram" onsubmit=" return saveval()" method="post" >
			...
			<table cellpadding=0 cellspacing=0 border=0 align="center" class="ListTable" id="templateInfo">
				<tr>
					<td align="left" class="EditHead"><font color="red">*</font>&nbsp;模板名称</td>
