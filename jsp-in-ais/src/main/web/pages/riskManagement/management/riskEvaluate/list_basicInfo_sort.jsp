...
<html>
<title>风险排序-风险应对策略-风险基本信息</title>
<head>
...
<body>
	<div class="easyui-panel" title="风险基本信息">
   	...
   	<br/>
	<!-- 风险评估结果确认 -->
	<%-- <div class="easyui-panel" style="height:570px;width:100%;padding:0px;" title="风险评估结果确认">
		<!-- <table id="gridRiskList" class="ListTable"  ></table> -->
		<iframe width=100% height=560 frameborder=0 scrolling="no" id="gridRisk"
		 	src="${contextPath}/riskManagement/management/riskEvaluate/listRiskWaitSureDetail.action?riskEvaluateWaitId=${riskEvaluateWaitId}">
		</iframe>
	</div> --%>
</body>
</html>
