    ...
    g1 = new createQDatagrid({
        ...
        gridJson:{    
            ...
            frozenColumns:[[
            				...
            				{field:'taskCode',title:'编号', width:bodyW*0.12 + 'px',align:'center', hidden:true},
            				{field:'taskName',title:'风险事项', width:bodyW*0.12 + 'px',align:'left', halign:'center',sortable:true, oper:'like'},
            				{field:'riskDescription',title:'风险描述', width:bodyW*0.12 + 'px',align:'left', halign:'center', sortable:true, oper:'like'},
            ...
            columns:[[
               ...
               {field:'taskPname',title:'风险分类', width:bodyW*0.12 + 'px', align:'left', halign:'center', sortable:true, type:'custom',target:$('#queryCond1')[0]},
               {field:'affiliatedDeptName',width:bodyW*0.12 + 'px',title:'所属单位',align:'left', halign:'center', sortable:true, type:'custom',target:$('#queryCond2')[0]},
               {field:'majorDutyDeptName',width:bodyW*0.12 + 'px',title:'主责部门', align:'left', halign:'center', sortable:true, type:'custom',target:$('#queryCond3')[0]},
               {field:'createTime',width:bodyW*0.13 + 'px',title:'上报时间', align:'center', sortable:true, type:'custom',target:$('#queryCond4')[0]},
              /*  {field:'operate',width:bodyW*0.14 + 'px',title:'操作', align:'center', sortable:false, show:'false', oper:'eq',
            	   formatter:function(value,rowData,rowIndex) {
            		   var url = '${contextPath}/riskManagement/management/majorRiskReport/editMajorRisk.action?taskId=' + rowData.taskId;
        			   return '<a href=\'#\' onclick="edit(\'' + url + '\')">修改</a>';
            	   }
               } */
        	]],
        }
