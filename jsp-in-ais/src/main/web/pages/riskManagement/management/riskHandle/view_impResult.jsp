...
<script type="text/javascript">
 ...
 $(function(){
	// 总体执行情况
	var implementation = '${handleProject.actualStartTime}';
	if(implementation != ''){
		init();
	}
});
	            ...
	            columns:[[
	               ...
	               {field:'operation',width:bodyW*0.13 + 'px',title:'操作', align:'center',show:'false',
	            	   formatter:function(value,rowData,rowIndex){
	            		   var url = '${contextPath}/riskManagement/management/riskHandle/enterImpResultInfo.action?isView=Y&hmId=' + rowData.id;
	            	       return '<a href=\'#\' onclick="enter(\'' + url + '\')">查看执行结果</a>';
	            	   }
	               }
	        	]]
	        }
...
<body>
    	...
    	<s:form id="myForm">
    		...
    		<table id='myTable' cellpadding=1 cellspacing=1 border=0 class="ListTable">
    			<tr>
	   				<td class="EditHead">风险控制状态</td>
    				<td class="editTd" colspan="3">
    					<select name="handleProject.riskConStatus" disabled="disabled">
    			...
    			<tr>
    				...
    				<td class="editTd">
    					<s:property value="handleProject.actualStartTime"/>
    				</td>
    				
    				<td class="EditHead">实际完成时间</td>
    				<td class="editTd">
    					<s:property value="handleProject.actualEndTime" />
    				</td>
    			</tr>
    			<tr>
    				<td class="EditHead">
    				...
    				<td class="editTd" colspan="3">
						<s:property value='handleProject.implementation'/>
					</td>
    			</tr>
    			<tr>
    				<td class="EditHead">
    				...
    				<td class="editTd" colspan="3">
						<s:property value='handleProject.remark2'/>
					</td>
    			</tr>
    		</table>
    	</s:form>
