	...
	var FirstPageTables = function(){
		return {
			show:function() {
	            ...
	            var series = [];
	            var legend = [];
	            $.getJSON('/ais/riskManagement/statistics/riskTrend/trendChartSearch.action?startyear=<%=request.getParameter("startyear")%>&endyear=<%=request.getParameter("endyear")%>&dept=<%=request.getParameter("dept")%>',{},function(json){
