...
<body class="easyui-layout" fit="true" style="overflow:hidden;" border='0'>
	<div region="west" border="0" split="true" title="" style="overflow:hidden;width:30%;">
		<iframe name="treeIframe" src="showTreeList.action?isView=${isView}&templateId=<%=request.getParameter("templateId")%>" frameborder="0"
		        style="height:100%;width:100%;overflow:hidden;"></iframe>
	</div>
	<div region="center" border="0"  style="overflow:hidden;">
		<iframe name="childBasefrm" src="showContent.action?isView=${isView}&selectedTab=main&taskPid=<%=request.getParameter("taskPid")%>&templateId=<%=request.getParameter("templateId")%>"
