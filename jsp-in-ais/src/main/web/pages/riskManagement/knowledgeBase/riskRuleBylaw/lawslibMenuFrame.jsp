  ...
  $(function(){
		...
		var winJson = showSysTree(treeTarget,{
			...
			param:{
                ...
                'treeOrder':'number(priority)',
                'treeAtrributes':'parentDeptId',
                'whereHql' :'classification=\'riskRuleBylaw\''
            },
		...
		try{
			...
			*/
	        ...
	        var timeout = window.setTimeout(function(){
	            //alert('nodeId='+nodeId)
	            if(nodeId){
	                var url = "<%=request.getContextPath()%>/commonPlug/getPriorNodeIdsById.action?rootParentId=null&whereHql=classification='riskRuleBylaw'&beanName=AssistSuportLawslibMenu&treeId=id&treeText=category_name&treeParentId=parent_id&treeOrder=priority";
