...
$(function(){
    ...
    for(i in columnUnfix) {
    	var tmp = {field:'influence' + i,width:bodyW*0.125 + 'px',title:columnUnfix[i].name, align:'center', sortable:true, 
           	   editor: {//设置其为可编辑
          		   type: 'textarea',
          		   options:  { required : true }
          		   }
        ...
        gridJson:{    
            ...
            toolbar:[{
            	...
            	handler:function () {
            		...
            		var newLine =  {//在指定行添加数据，appendRow是在最后一行添加数据
            				index: 0, // 行数从0开始计算
            				row: {
            				id: uuid,
            				sn: '',
            		...
            		$("#sDTable").datagrid('insertRow',newLine);
            	}
            }, '-', {  
                text: '保存', iconCls: 'icon-save', handler: function () {  
                    ...
                    $.ajax({
                    	url:'${contextPath}/riskManagement/knowledgeBase/riskRating/saveInfluenceSD.action',
                    	async:false,
                    	type:'POST',
