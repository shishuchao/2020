...
<div class="container-fluid">
	<div class="row" >
		...
		<div class="col-md-6">
			<div class="portlet light tasks-widget" >
				...
				<div class="portlet-body body-border body-height">
					<div class="task-content">
						<table id="myProjectTable" style="table-layout:fixed" class="table table-light">
							<thead>
								<tr style="background:#e3eefd;font-weight:bold;color:#838fa1!important;">
									<th style="width: 60%;">项目名称</th>
									<th style="width: 30%;text-align:left;">项目角色</th>
									<th style="width: 100px;text-align:left;">当前阶段</th>
								</tr>
							</thead>
							<tbody>
							</tbody>
	...
	<div  class="row" >
		<div class="col-md-6">
			<div class="portlet light tasks-widget" >
				<div class="portlet-title barBg title-border">
					<div class="rowTitleWrap" style='width:200px!important;'>					
						<span class="rowTitle">被评价单位整改反馈</span>
						<span class="rowTitleLogo"></span>						
					</div>
					<div class="tools">
						<a href="javascript:;" id="evaluatedUnit_more" title="更多">更多
							<i class="fa fa-angle-double-right" ></i>
						</a>
					</div>
				</div>
				<div class="portlet-body body-border body-height">
					<div class="task-content">
						<table id="evaluatedUnitTable" style="table-layout:fixed" class="table table-light">
							<thead>
								<tr style="background:#e3eefd;font-weight:bold;color:#838fa1!important;">
									<th style="width: 60%;">项目名称</th>
									<th style="width: 30%;text-align:left;">内控评价组织者</th>
...
<script src="${contextPath}/index/interCtrl_firstpage.js" type="text/javascript"></script>
