...
<html>
	...
	<div id="dlgSearch" class="searchWindow">
		<div class="search_head">
			<s:form id="searchForm" name="searchForm" action="onlineThrow" namespace="/portal/simple" method="post">
				<s:token/>
		...
		<script type="text/javascript">
            ...
            */
			...
			$(function(){
				...
				// 初始化生成表格
				$('#yearList').datagrid({
					url : "<%=request.getContextPath()%>/portal/simple/onlineThrow.action?querySource=grid&step=${param.step}&t="+new Date().getTime() ,
					method:'post',
					showFooter:false,
					rownumbers:true,
					pagination:true,
					...
					columns:[[
                        {field:'is_closed',title:'状态',halign:'center',align:'center',sortable:false, width:0.06*bodyW+'px',
                        ...
                        {field:'curStep',
                            ...
                            formatter:function(value, rowData, rowIndex){
                                if(rowData.xmType == 'syOff') {
                                    ...
                                    if((rowData.prepare_closed==null || rowData.prepare_closed == '' || rowData.prepare_closed=='0')&&rowData.planProcess=='simplified'){
                                        return '实施|终结'
									}
