...
<s:iterator value="#request.orgtree">
    <s:if test="${orgType!='1' && orgtype=='1'}">
<p  title="<s:property value="fname"/>" sid="<s:property value="fid"/>" pid="<s:property value="fpid"/>"></p>
</s:if>
<s:else>
<p  title="<s:property value="fname"/>" sid="<s:property value="fid"/>" pid="<s:property value="fpid"/>" click="getSelectedValue('<s:property value="fid"/>','<s:property value="fname"/>')"></p>
</s:else> 
</s:iterator>
</div>
