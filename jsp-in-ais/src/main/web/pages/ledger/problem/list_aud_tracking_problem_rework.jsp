...
<html>
	...
	<script type="text/javascript">
			$(function(){
				$('#trackList').datagrid({
					url : "<%=request.getContextPath()%>/proledger/problem/auditTrackingListRework.action?querySource=grid&project_id=<%=request.getAttribute("project_id")%>&permission=<%=request.getAttribute("permission")%>",
					method:'post',
					showFooter:false,
					rownumbers:true,
					pagination:true,
