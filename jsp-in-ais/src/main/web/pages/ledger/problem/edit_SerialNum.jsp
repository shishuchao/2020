...
<head>
	...
	<script type="text/javascript">
		function myCheck(){
			 obj=document.getElementById("ledgerProblem.serial_num");
			 if(obj.value==""){
...
<body>
    ...
    <table align="center" cellpadding=1 cellspacing=1 border=0 style='padding:5px; font-size:12px;text-align:center;'>
        <tr >
            ...
            <td style="width: 90%">
                <s:textfield id="ledgerProblem.serial_num" name="ledgerProblem.serial_num" cssStyle="width:90%"  />
                <s:hidden name="ledgerProblem.id" value="${id}" />
            </td>
        </tr>
    </table>
    </div>
