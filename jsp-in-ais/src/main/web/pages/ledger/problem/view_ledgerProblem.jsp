			...
			<table cellpadding=1 cellspacing=1 border=0 
				...
				<tr>
					...
					<td class="editTd" width="35%">
						<a style="cursor:hand" href="javascript:void(0);" onclick="viewManu()"/><s:property value="ledgerProblem.manuscript_name"/></a>
						<!-- <div style="float:right">
							<a id="" href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="closeViewProblem();">关闭</a>
						</div> -->
					</td>
					<td class="EditHead" width="15%">审计事项</td>
					<td class="editTd" width="35%">
		...
		<%-- 		<tr>
				...
				<tr>
					...
					<td class="editTd">
						...
						<%-- <s:if test="${ledgerProblem.ofsDetail != ''}">
							&nbsp;<s:property value="ledgerProblem.ofsDetail"/>
						</s:if> --%>
					</td>
				</tr>
			...
			<%-- 	<tr>
				...
				<%-- <tr>
					<td class="EditHead">与本单位经营战略相关度</td>
						<td class="editTd">
							<s:property value="ledgerProblem.tacticRelevancy"/>
						</td>
						<td class="EditHead">发生频率</td>
						<td class="editTd">
							<s:property value="ledgerProblem.occurrence"/>
						</td>
					</tr> --%>
				<tr>
