...
<html>
	...
	<body onload="createReportFile()">
		<s:form id="webform" name="webform">
			<s:hidden id="reportFileId" name="reportFile.fileId" />
			<s:hidden id="projectName" name="apName"/>
			<s:hidden id="projectId" name="apId" />
			<div id="buttonDiv" align="center">
				<button style="width:150px;" onclick="saveReportFile()">保存审计结论</button>
	...
	<script type="text/javascript">		
		...
		*/
		function createReportFile(){
			var reportFileId = document.getElementById('reportFileId').value;
			var projectName = document.getElementById('projectName').value;
			var projectId = document.getElementById('projectId').value;
			try{
				webform.WebOffice.WebUrl="${contextPath}/iweb/file"+reportFileId;
				webform.WebOffice.RecordID=reportFileId;
				webform.WebOffice.FileName=projectName+"审计报告.doc";
				...
				//创建成功后返回审计结论页面
				superWin.location.href="/ais/ea/audAccount/initClusionPage.action?apId=${apId}";				
			}catch(e){}
		}
