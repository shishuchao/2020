...
function WebOpenLocal(){
  try{
	...
	<body bgcolor="#ffffff" onload="Load()" onunload="UnLoad()" style="display: none; overflow: hidden;">
		<!--引导和退出iWebOffice-->
		<form name="webform" method="post" action="${contextPath}/commons/oaprint/saveTemplate.action" onsubmit="return SaveDocument();">
			<!--保存iWebOffice后提交表单信息-->
			<table cellpadding=0 cellspacing=0 border=0 bordercolor="red" style="width:100%;height:100%">
				<tr>
					<td align=right class="listtabletr11" eight="30">
						<div style='float:left;'>综合工作底稿:<label id='StatusBar' style='padding-left:5px;'>状态栏</label></div>
						<div style='float:right;padding:0px 5px 1px 0px;'>
