...
function Load(){
  ...
  /* if (window.confirm("导出实施方案模板成功，是否显示导出的实施方案模板文件？\n显示请点【确定】，并自行保存到本地。\n直接存到本地请点【取消】。")) {
...
//	WebSaveLocal();
	...
	<div>
	<body class="easyui-layout"   onunload="UnLoad()" rightmargin="10" style="overflow: hidden;">
		<!--引导和退出iWebOffice-->
		<form name="webform" method="post"
			...
			<table cellpadding=0 cellspacing=0 border=0  class="ListTable" align="center">
				<tr>
					<td align=right class="EditHead" eight="30">
						<input type="hidden" name="RecordID"
							value="<s:property value="mRecordID"/>">
						<iframe id="frmdeltmp" name="frmdeltmp" style="display: none;"
							src="about:blank"></iframe>
						<a href="javascript:void(0);" class="easyui-linkbutton" onclick="WebSaveLocal()">保存本地文件</a>&nbsp;
						<a href="javascript:void(0);" class="easyui-linkbutton" onclick="WebOpenPrint()">打印文件</a>&nbsp;
						<a href="javascript:void(0);" class="easyui-linkbutton" onclick="window.history.back();">关闭</a>&nbsp;
					</td>
				</tr>
				<tr>
					<td height="20">
