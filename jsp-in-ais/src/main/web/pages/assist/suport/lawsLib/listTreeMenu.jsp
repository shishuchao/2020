	...
	Ext.onReady(function(){
	 ...
	 <s:iterator value="m_list">
        ...
        var root=new Tree.TreeNode({
               ...
               href:'listByTypeKey.action?mCodeType=${mCodeType}&nodeid=${id}',
      ...
      <s:else>
      	<s:if test="${!isHaveChild}">
      		var node_${id}=new Tree.TreeNode({id:'${id}',text:'${category_name}',href:'listByTypeKey.action?mCodeType=${mCodeType}&nodeid=${id}',leaf:true,hrefTarget:'childBasefrm'});
      	</s:if>
      	<s:else>
      		var node_${id}=new Tree.TreeNode({id:'${id}',text:'${category_name}',href:'listByTypeKey.action?mCodeType=${mCodeType}&nodeid=${id}',leaf:false,hrefTarget:'childBasefrm'});
      	</s:else>
      </s:else> 
	</s:iterator>
	<s:iterator value="m_list">
