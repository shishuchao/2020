	...
	Ext.onReady(function(){
	 ...
	 <s:iterator value="m_list">
        ...
        var root=new Tree.TreeNode({
               ...
               href:'editMenu.action?m_view=view&nodeid=${id}',
      ...
      <s:else>
      	<s:if test="${!isHaveChild}">
      		var node_${id}=new Tree.TreeNode({id:'${id}',text:'${category_name}',href:'editMenu.action?m_view=view&nodeid=${id}',leaf:true,hrefTarget:'childBasefrm'});
      	</s:if>
      	<s:else>
      		var node_${id}=new Tree.TreeNode({id:'${id}',text:'${category_name}',href:'editMenu.action?m_view=view&nodeid=${id}',leaf:false,hrefTarget:'childBasefrm'});
      	</s:else>
      </s:else> 
	</s:iterator>
	<s:iterator value="m_list">
