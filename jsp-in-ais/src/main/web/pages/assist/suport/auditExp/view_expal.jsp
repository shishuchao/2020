...
<html>
	...
	<body>
		<center>
			<s:form action="alView" namespace="/pages/assist/suport/lawsLib" theme="simple">
				<table id="portalTab" cellpadding=1 cellspacing=1 border=0 bgcolor="#409cce" class="ListTable">
					<tr>
						...
						<td class="listtabletr2">
							<s:textfield name="al.name" cssStyle="width: 100%"></s:textfield>
						</td>
					</tr>
					<tr>
						<td class="listtabletr1">
						...
						<td class="listtabletr2">
							<s:textfield name="al.zz" cssStyle="width: 100%"></s:textfield>
						</td>
					</tr>
					<tr>
						<td class="listtabletr1">
						...
						<td class="listtabletr2">
							<s:textfield name="al.tjsj" cssStyle="width: 100%"></s:textfield>
						</td>
					</tr>
					<tr>
						<td class="listtabletr1">
						...
						<td class="listtabletr2">
							<s:textfield name="al.tjdw" cssStyle="width: 100%"></s:textfield>
						</td>
					</tr>
					<!-- 
					<tr>
