				...
				<table id="portalTab" cellpadding=1 cellspacing=1 border=0 bgcolor="#409cce" class="ListTable">
					<tr>
						...
						<td class="listtabletr2">
							<s:textfield name="bz.name" cssStyle="width: 100%"></s:textfield>
						</td>
					</tr>
					<tr>
						<td class="listtabletr1">
						...
						<td class="listtabletr2">
							<s:textarea name="bz.content" cssStyle="width: 100%"></s:textarea>
						</td>
					</tr>
					<tr>
						<td class="listtabletr1">
						...
						<td class="listtabletr2">
							<s:textarea name="bz.lsql" cssStyle="width: 100%"></s:textarea>
						</td>
					</tr>
					<!-- 
					<tr>
