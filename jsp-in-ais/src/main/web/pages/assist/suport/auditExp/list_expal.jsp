...
<html>
	...
	<body>
		<display:table name="alList" id="row" class="its" pagesize="10" requestURI="/pages/assist/suport/lawsLib/assistSuportLawslibAction!alList.action" defaultorder="descending" cellpadding="1">
			<display:column title="案例名称" property="name" sortable="true" headerClass="center" class="left"/>
			<display:column title="操作" sortable="false" headerClass="center" class="center">
				<a href="javascript:void(0);" onclick="window.open('${contextPath}/pages/assist/suport/lawsLib/assistSuportLawslibAction!alView.action?id=${row.id}','','toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no')">查看</a>
			</display:column>
		</display:table>
	</body>
</html>