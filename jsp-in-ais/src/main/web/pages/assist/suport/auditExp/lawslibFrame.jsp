		...
		<tr class="listtablehead">
			<td colspan="5" align="left" class="edithead">
				<div style="display: inline;width:80%;">
					<s:property escape="false" value="@ais.framework.util.NavigationUtil@getNavigation('/ais/pages/assist/suport/lawsLib/index.action?mCodeType=sjjy')"/>
				</div>
...
<div id="container" class='easyui-layout' fit='true'>
  <div id="content" title="<%--<img  style='vertical-align: middle; cursor: hand;' onclick=$('img[alt=操作帮助]').trigger('click') src='/ais/images/portal/default/window/icon-question-new.gif' />&nbsp;--%>类别" region='west' split='true' >
		<iframe name="f_left" width="100%" frameborder="0" height="100%" src="showTreeList.action?mCodeType=sjjy"></iframe>
  </div>
  <div id="sidebar" title='详细信息 -- <a href="javascript:void(0);" onclick="triggerSearchTable();">查询条件</a>' region='center' >
		<iframe name="childBasefrm" width="100%" frameborder="0" height="100%" src="listByTypeKey.action?mCodeType=sjjy&nodeid=${nodeid}" ></iframe>
  </div>
</div>
</html>