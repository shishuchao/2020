	...
	<head>
		...
		$(function(){
			...
			$('#yearDetailList').datagrid({
				<%--url : "<%=request.getContextPath()%>/plan/year/viewBU.action?querySource=grid&grade=1000",--%>
                url : "<%=request.getContextPath()%>/plan/year/viewBU.action?querySource=grid",
			...
			$('#normalDetailList').datagrid({
				url : "<%=request.getContextPath()%>/plan/year/viewBU.action?querySource=grid&grade=1001",
							...
							<s:form id="yearDetailPlanSearchForm" name="yearDetailPlanSearchForm" action="view" namespace="/plan/year">
								<table cellpadding=0 cellspacing=0 border=0 align="center" class="ListTable">
									...
									<tr >
										...
										<td class="editTd" >
											<s:buttonText2 id="pro_teamleader_name" cssStyle="width:160px;" readonly="true"
