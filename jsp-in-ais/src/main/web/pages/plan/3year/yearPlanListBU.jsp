...
$(function(){
	...
	var hql= "${hql}";
	var editUrl = '${contextPath}/plan/3year/editBU.action';
    ...
    cusToolbar = isView ? ['search','reload','-',expWordBtn,'-','export','-'] :
        ['search','-','reload','-',expWordBtn,'-','export'];
        ...
        gridJson:{
            ...
            onClickCell:function(rowIndex, field, value){
                if(field == 'planName'){
                    ...
                    aud$openNewTab("BU"+row['planName']+(eview ? "查看":"编辑"), editUrl+"?crudId="+row['formId']+(eview ? "&view=true" : ""), false);
                }
            },	
            frozenColumns:[[           	
