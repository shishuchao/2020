...
<%
	...
	String recordId = (String)request.getSession().getAttribute("audVindicateRecordId"); //模板id
	String filename = (String)request.getSession().getAttribute("audVindicateFilename"); //模板名称
	String type = (String)request.getSession().getAttribute("audVindicatType");
	...
	<body onload="openTemplate()">
		<div id="layDiv" class="easyui-layout" style="width: 100%; height: 900px;">
			...
			<div region="east" title="公式" style="width:100px">
			     <table width="100%">
			      <s:iterator value="#session.audVindicateFormulaList" id="formula">
