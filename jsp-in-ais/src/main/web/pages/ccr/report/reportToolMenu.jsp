...
<!--
function goback(){
	window.location.href="<%=request.getContextPath()%>/ccReport/reportList.action"
}
//-->
</script>
<TABLE class="cbToolbar" id="idTBGeneral" style="display: 'none'" cellpadding='0' cellspacing='0' width="100%">
	...
	<TD class="tbDivider" NOWRAP valign=bottom><A class=tbButton id=cmdMxData title=返回报表列表 href="javascript:;" name=cbButtoncmd onclick="javascript:goback()"><font color=blue>返回</font></A></TD>
...
<TABLE class="cbToolbar" id="idTBFormat" style="display: 'none'" cellpadding='0' cellspacing='0' width="100%">
	...
	<s:if test="${report.unitId==session.user.fdepid}">
		<s:if test="${report.declearFlag==0}">
			<TD class="tbDivider" NOWRAP valign=bottom>
				<s:if test="${sumFlag>0}">
					<A class=tbButton id=cmdMxData title="选择下级单位" href="javascript:;" name=cbButtoncmd onclick="javascript:selChildDept()"><font color=blue size="3">下级单位</font></A>
					<s:hidden name="childId"></s:hidden>
					<s:textfield name="childName" cssStyle="width:280px; HEIGHT: 23px"></s:textfield>
					<A class=tbButton id=cmdMxData title="汇总" href="javascript:;" name=cbButtoncmd onclick="javascript:summary('')"><font color=blue size="3">汇总</font></A>
				</s:if>
				<A class=tbButton id=cmdMxData title="申报" href="javascript:;" name=cbButtoncmd onclick="javascript:declare('')"><font color=blue size="3">申报</font></A>
			</TD>
		</s:if>
	</s:if>
...
<TABLE class="cbToolbar" id="idTBDesign" style="display: 'none'" cellpadding='0' cellspacing='0' width="100%">
	...
	<TD NOWRAP>公式:<input type="text" id="formulaName" name="formulaName" value="" style="width:280px;height:23px"></TD>
	<TD width="100%">
	</TD>
	</TR>
</TABLE>