...
<body style="margin: 0;padding: 0;overflow:hidden;" class="easyui-layout" onload="setWorkProgramId();">
	<div id="exportFileSearch" class="searchWindow">
		...
		<s:form action="exportFileZipIC" namespace="/archives/borrow" name="form" id="form">
...
<script type="text/javascript">
	...
	$(function(){
		...
		// 初始化生成表格
		$('#allArchivesList').datagrid({
			url : "<%=request.getContextPath()%>/archives/borrow/exportFileZipIC.action?querySource=grid",
			method:'post',
			showFooter:false,
			rownumbers:true,
			pagination:true,
			...
			columns:[[
			    ...
			    {field:'archives_type_name',title:'档案类型',width:80,sortable:true,halign:'center',align:'center'},
				{field:'pro_type_name',
						title:'项目类别',
						halign:'center',
						align:'left', 
