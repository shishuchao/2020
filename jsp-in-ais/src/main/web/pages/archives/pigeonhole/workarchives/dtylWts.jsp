...
<body style='margin:0;padding: 0;overflow:hidden;'  border='0' fit='true' class="easyui-layout">
					...
					<tr>
						...
						<td  colspan="5">
							<div style="margin-left:3%; width:80%;float:left;margin-top: 10px">
				                  ...
				                  <input type="radio" name="wtpm"  class="radioBox" value="org"    onclick="changeRadioType('org')"
				                  ...
				                  &nbsp;&nbsp;&nbsp;
				                  <input type="radio" name="wtpm" class="radioBox" value="wtd" checked="checked"  onclick="changeRadioType('wtd')"
 ...
 <script type="text/javascript">
	...
	var sort="${sort}";	 	
	 ...
	 $('#iframe').attr('src','${contextPath}/pages/archives/pigeonhole/workarchives/dtlyWtd.jsp?pro_year='+pro_year+'&audit_dept='+audit_dept+'&audit_object='+audit_object+'&topN='+topN+'&pro_type='+pro_type+'&sort_big_code='+sort_big_code+'&mend_state='+mend_state+'&type='+type+'&sort='+sort);
...
function doSearch(){  
		...
		$('#iframe').attr('src','${contextPath}/pages/archives/pigeonhole/workarchives/dtlyWtd.jsp?pro_year='+pro_year+'&audit_dept='+audit_dept+'&audit_object='+audit_object+'&topN='+topN+'&pro_type='+pro_type+'&sort_big_code='+sort_big_code+'&mend_state='+mend_state+'&type='+type);
