...
<head>
	...
	<script type="text/javascript">
		...
		function back(){
			var url = "${contextPath}/archives/pigeonhole/borrowLogList.action";
	 		window.location = url;
		}
		/*
	     * 关闭和隐藏查询条件
...
<body style="margin: 0;padding: 0;overflow:hidden;" class="easyui-layout">
	<div id="allArchivesSearch" class="searchWindow">
		<div class="search_head">
			<s:form action="borrowLog" namespace="/archives/borrow" id="form" name="form">
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			// 初始化生成表格
			$('#allArchivesList').datagrid({
				url : '<%=request.getContextPath()%>/archives/borrow/borrowLog.action?querySource=grid&project_id=${project_id}&project_name=${project_name}',
				method:'post',
				showFooter:false,
				rownumbers:true,
				pagination:true,
