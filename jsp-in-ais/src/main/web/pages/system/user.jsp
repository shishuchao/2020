...
<HEAD>
	...
	<link href="<%=request.getContextPath()%>/styles/main/ais2.css" rel="stylesheet" type="text/css">
...
<script language="Javascript">
	...
	function getCheck(){
 		showMessage2(configtree.GetSelected());
 	}
	...
	function showOwnAllRoles(){
		var s=getCheckValue();
		if(s==""){
			showMessage2("请选择要设置权限的用户.");return(false);
		}
		if(s.indexOf(";")!=-1){
			showMessage2("只能选择一项.");return(false);
		}
		var array=s.split(",");
		var loginname=array[1];
...
<div id="m_div" style="text-align:right;">
	...
	<td>
		...
		<td>	
		<div id="oneSelect2" class="imgbtn" style="width:50px;" Imgsrc="<%=request.getContextPath()%>/resources/images/sall.gif" Background="#D2E9FF" Text="取消" onclick="allNochk();"></div>
		</td>
...
<div align="center">
<display:table name="userlist" id="row" class="its" pagesize="10" requestURI="uSystemAction!getUserList.action?p_deptid=${p_deptid}&p_deptname='${p_deptname}'&p_issel=${p_issel}&p_item=${p_item}&deptFx=${deptFx}&zhiwuCode=${zhiwuCode}&zhichengCode=${zhichengCode}" excludedParams="*">
