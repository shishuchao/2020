...
<HEAD>
	...
	<SCRIPT type="text/javascript"><!--
		...
		var params2=$("#group_id").serialize(); 
		...
		//var params = $("div").text($("form").serialize()); 
			$.ajax({   
		        ...
		        data: params,
		        dataType : "json",   
		        url: "<%=request.getContextPath()%>/mng/audobj/object/doGetPrivilegeTreeByGroupId.action",//请求的action路径   
		        //data:{searchKey:["s"],
		    ...
		    var treeObj = $.fn.zTree.getZTreeObj("treeDemo");
		  	var ids = document.getElementById("audit_ids_object").value ;
		  	if(ids!=null && ids!=''){
	...
	<script type="text/javascript">
		function searchAudit(){
			...
			flowForm.action="<%=request.getContextPath()%>/mng/audobj/object/doGetPrivilegeTreeByGroupId.action" ;
			flowForm.submit();
		}
		function resetKey(){
		document.getElementById("searchKey").value = '' ;
		var wherepa = document.getElementById("where").value;
			window.location = "<%=request.getContextPath()%>/mng/audobj/object/doGetPrivilegeTreeByGroupId.action?where="+wherepa ;
		}
			 ...
			 <form id="permissionform" method="post">
	            	...
	            	<ul class="list">
						...
						<li>
		                    	...
		                    	<s:hidden name="group_id" value="${group_id}"></s:hidden>
		                    	<s:hidden name="audit_ids_object" value="${audit_ids_object}"></s:hidden>
		                    	关键字：
