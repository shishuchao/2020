...
<HEAD>
	...
	<SCRIPT type="text/javascript"><!--
		...
		var params3=$("#project_id").serialize(); 
		var params=params0+"&"+params1+"&"+params2+"&"+params3; 
		//var params = $("div").text($("form").serialize()); 
			$.ajax({   
		        ...
		        data: params,
		        dataType : "json",   
		        url: "<%=request.getContextPath()%>/mng/audobj/object/doGetPrivilegeTreeSelect.action",//请求的action路径   
		        //data:{searchKey:["s"],
	...
	<script type="text/javascript">
		function searchAudit(){
			...
			flowForm.action="<%=request.getContextPath()%>/mng/audobj/object/auditedDeptListByZtreeByIdsSelect.action" ;
			flowForm.submit();
		}
		function resetKey(){
		document.getElementById("searchKey").value = '' ;
		var wherepa = document.getElementById("where").value;
			window.location = "<%=request.getContextPath()%>/mng/audobj/object/auditedDeptListByZtreeByIdsSelect.action?where="+wherepa ;
		}
			 ...
			 <form id="permissionform" method="post">
	            	...
	            	<ul class="list">
						...
						<li>
		                    	...
		                    	<s:hidden name="project_id" value="${project_id}"></s:hidden>
