...
<div align="center">
<display:table name="userlist" id="row" class="its" 
	pagesize="${baseHelper.pageSize}" partialList="true"
	size="${baseHelper.totalRows}"  requestURI="/mng/employee/getEmployeeList.action?p_issel=${p_issel}&p_item=${p_item}&p_deptid=${p_deptid}&p_deptname='${p_deptname}'" 
	excludedParams="*" >
