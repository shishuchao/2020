...
<html>
	...
	<body>
		<s:form action="employeeEducateUpdate" namespace="/mng/employee">
			...
			<TABLE id="edu" width="100%" border=0 cellPadding=0 cellSpacing=1
						class=ListTable align="center">
				<TR class=ListTableTr1>
					...
					<TD class=ListTableTr2 width="29%"  align="left">
						<s:textfield name="employeeEducate.educateItem" size="32" maxlength="32"/>
					</TD>
				...
				<TR>
					...
					<TD class=ListTableTr2 colspan="3" align="left">
						<s:textarea name="employeeEducate.educateContent" title="培训内容" >
						</s:textarea>
			...
			<s:hidden name="employeeEducate.id"/>
