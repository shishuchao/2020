...
<html>
	<head>
		<s:text id="title" name="'中介机构信息维护'"></s:text>
	...
	<body >
			...
			<s:form action="/resmngt/integory/save_integoryinfo.action" name="form1" namespace="/resmngt/integory">
				...
				<table  id="tab1"  class=ListTable >
					<tr>
						...
						<td class="ListTableTr22">
							<s:textfield id="unitname" name="integoryinfoW.unitname" 
					...
					<tr>
						...
						<td class="ListTableTr22">
							<s:textfield name="integoryinfoW.address"  maxlength="50"></s:textfield>
						</td>
						<td width="23%" align="right" class="ListTableTr11">
							邮政编码
						</td>
						<td class="ListTableTr22">
							<s:textfield id="integoryinfoW.post" name="integoryinfoW.post"  maxlength="6"></s:textfield>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="ListTableTr22">
							<s:textfield id="integoryinfoW.phone" name="integoryinfoW.phone"  maxlength="20"></s:textfield>
							型如：(010-88888888-888)
						</td>
						<td width="23%" align="right" class="ListTableTr11">
							联系人
						...
						<td class="ListTableTr22">
							<s:textfield name="integoryinfoW.linkman"  maxlength="50"></s:textfield>
						</td>
					</tr>
					<tr>
						<td width="23%" align="right" class="ListTableTr11">
				...
				<div align="right">
					...
					<s:hidden name="integoryinfoW.fjid"></s:hidden>
					<input type="button" onclick="save()" value="保存并返回"/>
					&nbsp;&nbsp;&nbsp;&nbsp;
