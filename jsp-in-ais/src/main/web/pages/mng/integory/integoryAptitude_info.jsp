	...
	<head>
		...
		<script type="text/javascript">	
			...
			function Upload(id,filelist){
				...
				window.showModalDialog('${contextPath}/commons/file/welcome.action?guid='+guid+'&deletePermission=true&isEdit=false&param='+rnm,filelist,'dialogWidth:700px;dialogHeight:450px;status:yes');
			}
		</script>
	</head>
	<body>
		<s:form action="saveAptitude" namespace="/project/integory">
			...
			<TABLE id="tab1" width="100%" border=0 cellPadding=0 cellSpacing=1 class=ListTable align="center">
				<TR>
					...
					<TD class=ListTableTr2>
						<s:textfield name="integoryAptitude.aptitudeName" cssStyle="width:300px" maxlength="100" readonly="true"></s:textfield>
						<s:hidden name="integoryAptitude.aptitudeCode"></s:hidden>
				...
				<TR>							
					...
					<TD class=ListTableTr2 align="left">
						<s:textfield name="integoryAptitude.code" cssStyle="width:300px" maxlength="100" readonly="true"/>
					</TD>
					</TR>
				<TR>
					...
					<TD class=ListTableTr2 align="left">
						<s:textfield name="integoryAptitude.promulgateUnit" cssStyle="width:300px" maxlength="100" readonly="true"/>
					</TD>
				</TR>
				<TR>
					<TD class=ListTableTr1 >
				...
				<TR>
					...
					<TD class=ListTableTr2 align="left">
						<s:textfield name="integoryAptitude.checkResult" cssStyle="width:300px" maxlength="100" readonly="true"/>
					</TD>
				</TR>
				<TR>
					<TD class=ListTableTr1 >
					...
					<TD class=ListTableTr2 align="left">
						<s:textfield name="integoryAptitude.remark" cssStyle="width:300px" maxlength="100" readonly="true"/>
					</TD>
				</TR>
				<tr>
					<td class="ListTableTr1">
						<s:button value="上传附件"></s:button>
			...
			<div align="center">			
				<s:submit action="integoryAptitude_List_view" value="返回"/>
			</div>
