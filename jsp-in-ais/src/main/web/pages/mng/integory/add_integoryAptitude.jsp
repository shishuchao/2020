...
<html>
	<head>
		...
		<script type="text/javascript">	
			function save(){	
				if(frmCheck(document.forms[0],'tab1') && checklength() == true){
			...
			function checklength(){
				var bl = true;
				var lth = document.getElementById("beizhu").value;
				if(lth.length<400){
					return bl;
				}else{
				    alert("备注100个汉字以内,若大于100，请上传附件");
				    bl = false;
					return bl;
				}
			}
	...
	<body>
		<s:form action="saveAptitude" namespace="/resmngt/integory">
			...
			<TABLE id="tab1" width="100%" border=0 cellPadding=0 cellSpacing=1 class=ListTable align="center">
				...
				<TR>
					<TD class=ListTableTr1 >
						备注(100字以内，若大于100字，请上传附件.)
					</TD>
					<TD class=ListTableTr2 align="left">
						<s:textarea id="beizhu" name="integoryAptitude.remark"></s:textarea>
					</TD>
				</TR>
				<tr>
					<td class="ListTableTr1">
