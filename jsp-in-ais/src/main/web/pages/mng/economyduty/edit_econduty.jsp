...
<head>
	...
	<script type="text/javascript">
		$(function(){
	  		...
	  		$('#beginDate').datebox('setValue','${econDutyBaseInfo.beginDate}');
	  		$('#endDate').datebox('setValue','${econDutyBaseInfo.endDate}');
	  		$('#birth').datebox('setValue','${econDutyBaseInfo.birth}');
	  	});
	   /*
		* 删除附件
		*/
		...
		function save(){
            ...
            var zzzt = document.getElementsByName('econDutyBaseInfo.incumbencyStateCode')[0].value;
			...
			window.parent.closeWin('showEcondutyDlg');
		}
	</script>
</head>
		...
		<s:form action="economyDutyAction!save" namespace="/mng/economyduty" id="serchForm">
			...
			<table id="tab1" cellpadding=0 cellspacing=0 border=0 align="center" class="ListTable">
				...
				<tr>
					...
					<td class="editTd">
						<input class="easyui-datebox" name="econDutyBaseInfo.birth"  value="${econDutyBaseInfo.birth}"title="单击选择日期" editable="false" width="150px"  />
					</td>
					<td nowrap class="EditHead">民族</td>
					<td class="editTd">
						<select class="easyui-combobox" name="econDutyBaseInfo.nationCode" editable="false"
								style="width:150px;">
							<option value="">&nbsp;</option>
				...
				<tr>
					...
					<td nowrap class="EditHead">政治面貌</td>
					<td class="editTd">
						<select class="easyui-combobox" name="econDutyBaseInfo.polityVisageCode" editable="false"
								style="width:150px;">
							<option value="">&nbsp;</option>
				...
				<tr>
					...
					<td nowrap class="EditHead">执业资格</td>
					<td class="editTd">
						<s:buttonText2 id="competence" name="econDutyBaseInfo.competence"
									   ...
									   cssClass="noborder"
									   doubleOnclick="queryData('/ais/mng/employee/queryCompetence.action?zyzgCode=${econDutyBaseInfo.competenceCode}','执业资格',440,410,'competenceCode','competence')"
									   doubleSrc="${pageContext.request.contextPath}/easyui/1.4/themes/icons/search.png"
									   doubleCssStyle="cursor:hand;border:0" readonly="true" />
					</td>
				</tr>
				<tr>
					...
					<td class="editTd">
						<s:textfield cssClass="noborder" name="econDutyBaseInfo.mobileTelephone" size="37"
									 maxlength="20" />
					</td>
					<td class="EditHead">电子邮箱</td>
					<td class="editTd">
						<s:textfield cssClass="noborder" name="econDutyBaseInfo.email" size="37"
									 maxlength="64" />
					</td>
				</tr>
				<tr>
					<td nowrap class="EditHead">
						任职经历
						<br>
						<font color="#a9a9a9">(限1000个字)</font>
					</td>
				...
				<tr>
					...
					<td class="editTd" colspan="3">
						<s:buttonText2 cssClass="noborder" name="econDutyBaseInfo.company"
				...
				<tr>
					...
					<td class="editTd" colspan="3">
						<s:if test="${econDutyBaseInfo.audit_end_time != null}">
							<s:textfield
									cssClass="noborder"
				...
				<tr>
					<td nowrap class="EditHead">
						<font color=red>*</font>&nbsp;在职状态</td>
					<td class="editTd">
						<select  class="easyui-combobox" name="econDutyBaseInfo.incumbencyStateCode" editable="false" style="width:150px;"  >
					       <option value="">&nbsp;</option>
					...
					<td class="editTd" width="35%">
						<s:textfield cssClass="noborder"  name="econDutyBaseInfo.personCode" size="37"
									 maxlength="64" />
					</td>
				</tr>
				<tr>
					...
					<td class="editTd">
						<s:textfield cssClass="noborder" name="econDutyBaseInfo.department" size="37"
							maxlength="64" />
					</td>
					<td nowrap class="EditHead">职务</td>
					<td class="editTd">
						<select class="easyui-combobox" name="econDutyBaseInfo.dutyCode" editable="false"
								style="width:150px;">
							<option value="">&nbsp;</option>
				...
				<tr>
					<td nowrap class="EditHead">任职开始日期</td>
					<td class="editTd">
						<!--<s:textfield cssClass="noborder" name="econDutyBaseInfo.beginDate" readonly="true"
							maxlength="20" title="单击选择日期" size="37" onclick="calendar()"></s:textfield>-->
						<input type="text" title="单击选择日期" name="econDutyBaseInfo.beginDate" id="beginDate" editable="false" class="easyui-datebox">	
					</td>
					<td nowrap class="EditHead">任职文件号</td>
					<td class="editTd">
						<s:textfield cssClass="noborder" name="econDutyBaseInfo.beginDocNum" size="37"
							maxlength="64" />
					</td>
				</tr>
				<tr>
					<td nowrap class="EditHead">任职结束日期</td>
					<td class="editTd">
						<!--<s:textfield cssClass="noborder" name="econDutyBaseInfo.endDate" readonly="true"
							maxlength="20" title="单击选择日期" size="37" onclick="calendar()"></s:textfield>-->
						<input class="easyui-datebox" id="endDate" name="econDutyBaseInfo.endDate" type="text" editable="false" title="单击选择日期">
					</td>
					<td nowrap class="EditHead">离职文件号</td>
					<td class="editTd">
						<s:textfield cssClass="noborder" name="econDutyBaseInfo.endDocNum" size="37" maxlength="64" />
					</td>
				</tr>
				<tr>
					<td nowrap class="EditHead">经济责任描述
						<br>
						<font color="#a9a9a9">(限3000个字)</font>
					</td>
					<td class="editTd" colspan="3">
						<s:textarea cssClass="noborder" id="bewrite" name="econDutyBaseInfo.bewrite" title="经济责任描述" cssStyle="width:100%"></s:textarea>
					</td>
				</tr>
				<tr>
			...
			<s:hidden name="econDutyBaseInfo.id"/>
		</s:form>
	</div>
