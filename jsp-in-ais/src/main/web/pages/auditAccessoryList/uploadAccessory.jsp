...
<link href="${contextPath}/resources/csswin/subModal.css" rel="stylesheet" type="tsext/css" />
...
function Upload(idName){
	...
	var width = 500;
	var height = 450;
	uploadFileResource(contextPath,deletePermission,isEdit,idName,width,height)
}
...
<body>
<table id="auditAccessoryListTable" cellpadding=0 cellspacing=1 border=0  bgcolor="#409cce" class="ListTable" >
<tr>
<td align="left" class="listtabletr11" style="text-align:left;width:15%">
    <input type="button" value="上传附件" onclick="Upload('accelerys')" />
</td>
