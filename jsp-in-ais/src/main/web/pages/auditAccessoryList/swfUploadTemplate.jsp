...
<html>
	...
	<form name="tempForm" method="post">
		...
		<s:form action="saveTemplate" method="POST" namespace="/auditAccessoryList"
			...
			<div align="center">
				<display:table name="fileList" id="row" class="its" pagesize="10"
					requestURI="/auditAccessoryList/welcome.action" size="100%">
...
<script type="text/javascript">
		...
		window.onload = function() {
			var settings = {
				...
				upload_url: "${contextPath}/auditAccessoryList/saveTemplate.action",			//pload_url设置接收的是一个绝对的或者相对于SWF文件的完整URL。推荐使用完整的绝对路径，以避免由浏览器和FlashPlayer修改了基准路径设置而造成的请求路径错误。
				post_params: {"aaid" : "${aaid}","table_name":"${table_name}"},			//定义的是一个包含值对的object类型数据，每个文件上传的时候，其中的值对都会被一同发送到服务端。
