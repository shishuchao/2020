...
$(function(){
	var busBaseUrl = "${contextPath}/syBasicsParse/";
    ...
    var busGridObj = new createQDatagrid({
        ...
        gridJson:{
    		...
    		columns:[[
                ...
                {field:'parseType', title:"类型",width:'65px',align:'center', halign:'center', sortable:true,
                    type:'custom', target:$('#queryCond4')[0], exportField:'qyName',
                    formatter:function(value,row,index){
                        var vtext = "";
                        $.each(typeArr, function(i, jdata){
                            if(jdata['code'] == value){
                                vtext = jdata['name'];
                                return false;
                            }
...
<body style='padding:0px;margin:0px;overflow:hidden;' class="easyui-layout" fit="true" border="0">
    ...
    <div id="queryCond4">
        <select  name='query_eq_parseType'  id="queryParseType" class="easyui-combobox"
                 data-options="panelHeight:80" editable="false" >
            <option value="" selected>全部</option>
