...
<head>
	...
	<script type="text/javascript" src="${contextPath}/pages/policySupport/js/problemNumberAnalyse.js"></script>
	...
	<script type="text/javascript">
		...
		var defaultUrl = '${contextPath}/pages/policySupport/problemStatisticsAnalyse/problemNumberAnalyseCharts.jsp?';
...
<body fit='true' class="easyui-layout">
   <div class="container-fluid" region='north' >
        <div id="search" class="searchquerstion"> 
			<s:form action="rankingQuestionsSearch" namespace="/archives/workprogram/pigeonhole" method="post">
				<table cellpadding=0 cellspacing=0  border=0 class="searchquestionstable" >
					...
					<tr>
						<td ></td>
						<td align="right" class="editqhead1"><span style="color:red">*</span>TOP N&nbsp;&nbsp;&nbsp;</td>
						<td class="Td">
							<input type="number" style="width:75%" min="0" value="10" id="topN" name="topN">
						</td>	
					</tr>
					<tr>
						...
						<td colspan="5">
							<div class="searchdimension">								
				                <input type="radio" name="totleDimension" value="org" checked="checked" onclick="changeRadioType('org')"/>
				                <label class="radioText" for="auditcompany">审计单位</label>
				                &nbsp;&nbsp;&nbsp;
				                <input type="radio" name="totleDimension" value="obj"  onclick="changeRadioType('obj')"/>
				                <label class="radioText" for="auditedcompany">被审计单位</label>
				                &nbsp;&nbsp;&nbsp;
				                <input type="radio" name="totleDimension" value="protype"  onclick="changeRadioType('protype')"/>
				                <label class="radioText" for="projecttype">项目类别</label>
				                &nbsp;&nbsp;&nbsp;
				                <input type="radio" name="totleDimension" value="sortbig"  onclick="changeRadioType('sortbig')"/>
				                <label class="radioText" for="problemtype">问题一级分类</label>
				                &nbsp;&nbsp;&nbsp;
				                <input type="radio" name="totleDimension" value="wtd"  onclick="changeRadioType('wtd')"/>
				                <label class="radioText" for="problempoint">问题点</label>
			             	</div>
				            <img id="reverseOrder" class="questionorder" title="倒序" onclick="sorting('zx')" src="/ais/images/decline.png"/>
						    <img id="positiveOrder" class="questionorder" title="正序" onclick="sorting('dx')" src="/ais/images/rise.png"/> 
						</td>
				    </tr>	
				</table>
	       </s:form>
   ...
   <div region='center' title="问题数量排名"  >
