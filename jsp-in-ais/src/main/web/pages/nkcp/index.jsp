			...
			<table style="padding: 0;border-spacing: 0;border-collapse: 0;width:98%;margin: 0;">
				<tr class="listtablehead">
					<td colspan="5" align="left" class="edithead">
						<s:property escape="false" value="@ais.framework.util.NavigationUtil@getNavigation('/ais/nkcp/listNeiKongProject.action')"/>
					</td>
				</tr>
			</table>
			<div style="height: 91%;padding: 0;margin: 0; border: 0;width:98%;">
				<div id="content">
					<iframe name="left" scrolling="auto" noresize 
						src="/ais/nkcp/tree.action?projectFormId=<s:property value="projectFormId"/>" 
