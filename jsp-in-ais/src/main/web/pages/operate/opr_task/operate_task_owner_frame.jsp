...
<html>
	<head>
		...
		Ext.onReady(function(){
		    ...
		    //左侧树，“我的任务”是一个grid
		    workPanel2.left.loadUrl({url:'${pageContext.request.contextPath}/operate/taskExt/taskUiOwner.action?owner=true&permission=<%=request.getParameter("permission")%>&isView=<%=request.getParameter("isView")%>&project_id=<%=request.getParameter("project_id")%>'});
		    //设置当前tab
