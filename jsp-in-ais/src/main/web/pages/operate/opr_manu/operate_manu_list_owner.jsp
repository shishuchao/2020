...
<html>
	<head>
		...
		Ext.onReady(function(){
	        ...
	        var dataModelDigao={url:'${pageContext.request.contextPath}/operate/manuExt/manuListJson.action?taskId=<%=request.getParameter("taskId")%>&permission=<%=request.getParameter("permission")%>&isView=<%=request.getParameter("isView")%>&project_id=<%=request.getParameter("project_id")%>&isAll=<%=request.getParameter("isAll")%>',
     ...
     function piliangDelOwner(){
      ...
      //-------------ext底稿查询form开始------------------
       ...
       var viewModelFrom ={
		 ...
		 {fieldLabel:'底稿类型',name:'audManuscript.manuTypeName',value:'',columnWidth:'1',layout:'form'},
