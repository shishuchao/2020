...
<%@ taglib uri="http://fckeditor.net/tags-fckeditor" prefix="FCK"%>
  <%@page import="ais.framework.util.MyProperty"%>
    <s:text id="title" name="'编辑审计结论'"></s:text>
		...
		<s:if test="'enabled' == '${shenjichengxu}'">
			...
			<s:form id="myform" onsubmit="return true;" action="/ais/operate/task" method="post" >
               <div align="left" style="color: #007FFF;" >
				<a href="javascript:void(0);" onclick="javascript:task()" title="${audTask.url}"><div class="divSim" style="cursor:hand">&nbsp;&nbsp;&nbsp;&nbsp;审计事项: ${audTask.url}</div></a>
				</div>
				...
				<s:button value="导出" onclick="subExport();" />&nbsp;&nbsp;
				 <s:if test="'enabled' == '${shenjichengxu}'">
