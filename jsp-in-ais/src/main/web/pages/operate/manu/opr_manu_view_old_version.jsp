	...
	if(manuType=='COMPREHENSIVE'){
        ...
        function getTai(rows) {
            ...
            if (ms_code == "" || ms_code == "null") {
                ...
                iframe.src = "/ais/proledger/problem/viewOldVersionProblem.action?project_id=${crudObject.project_id}&manuscript_id=${crudObject.id}&manuscriptType=digao&view=view";
            }
...
<div class='easyui-layout' fit='true' border='0'>
        ...
        <center>
            ...
            <table id="myform" class="ListTable" style="width:98%">
                ...
                <tr>
                    ...
                    <td class="editTd"><s:property value="crudObject.linkManuName"/></td>
                    <td class="EditHead" style="width: 15%"></td>
                    <td class="editTd " style="width:35%"></td>
                </tr>
                ...
                <%--<tr id="record">
                    <td class="EditHead">审计过程记录</td>
                    <td class="editTd" colspan="3">
                        <textarea class='noborder'  name="crudObject.audit_record" readonly="readonly"
                            rows="5" style="border-width:0px;width:98%;overflow-y:visible;line-height:150%;">${crudObject.audit_record}</textarea>
                    </td>
                </tr>
                <tr>
                        <td class="EditHead">审计结论</td>
                        ...
                        <td class="editTd" colspan="3">
                            <textarea class='noborder'  name="crudObject.audit_con" readonly="readonly"
                                      rows="1" style="border-width:0px;width:98%;overflow-y:visible;line-height:150%;"  >${crudObject.audit_con}</textarea>
                        </td>
                    </tr>--%>
                ...
                <s:if test="${tableType == '1'}">
                    <tr>
                        ...
                        <td class="editTd">
                            ...
                            <img src="<%=request.getContextPath()%>/resources/images/s_search.gif" onclick="getGroup();"
                    ...
                    <tr>
                        ...
                        <td class="editTd" colspan="5">
									<textarea class='noborder' name="ledgerProblem.sjjl" readonly="readonly"
                                              rows="5"
                                              style="border-width:0px;width:98%;overflow-y:visible;line-height:150%;">${crudObject.sjjl}</textarea>
                    ...
                    <tr>
                        ...
                        <td class="editTd" colspan="5">
									<textarea class='noborder' name="ledgerProblem.ssms" readonly="readonly"
                                              rows="5"
                                              style="border-width:0px;width:98%;overflow-y:visible;line-height:150%;">${crudObject.ssms}</textarea>
                    ...
                    <tr>
                        ...
                        <td class="editTd" colspan="5">
                            <s:textarea name="ledgerProblem.cljd" title="处理决定" id="cljd"
                                        cssClass='autoResizeTexareaHeight'
                                        cssStyle="border-width:0px;width:90%;height:200"/>
                ...
                <s:if test="'GZNX' == '${dqxm}'">
                    ...
                    <tr>
                        <td class="editTd" colspan="4">
                            ...
                            <s:textarea cssClass='noborder' name="crudObject.audit_method_name" readonly="true"
                                        disabled="true"
                                        rows="5"
                                        cssStyle="border-width:0px;width:100%;overflow-y:visible;line-height:150%;"/>
                        </td>
                    </tr>
                </s:if>
    ...
    <div region='south' border='0' style='text-align:center;'>
        <s:if test="(interaction!=null && interaction=='interaction' )|| (${viewmanu != 'process' })">
            <div data-options="fileGuid:'${crudObject.file_id}',
			isAdd:false,isEdit:false,isDel:false,callbackGridHeight:200"
                 class="easyui-fileUpload"></div>
        </s:if>
        <s:else>
            <div id="manu_file" class="easyui-fileUpload"
                 data-options="fileGuid:'${crudObject.file_id}',isAdd:false,isEdit:false,isDel:false,callbackGridHeight:200"></div>
        </s:else>
    </div>
</div>
