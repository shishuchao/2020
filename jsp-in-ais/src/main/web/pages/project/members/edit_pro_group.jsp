...
<html>
  ...
  <body>
  	<s:form id="groupForm" action="saveGroup" namespace="/project/members"> 
	...
	<script type="text/javascript">
		function toSave(){
			...
			groupForm.submit();
			win.location.href='/ais/project/members/edit.action?projectFormId=${projectFormId}&selectedTab=projectGroupDiv';
			window.close();
		}
	</script>
