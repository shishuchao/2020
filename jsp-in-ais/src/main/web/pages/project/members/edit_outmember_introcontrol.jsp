...
<html>
  ...
  <body>
  	<s:form id="memberOutForm" name="memberOutForm" action="saveMember!introcontrolSaveMember.action" namespace="/project"> 
		...
		<table id="projectMemberTable" cellpadding="0" cellspacing="1" border="0" bgcolor="#409cce" class="ListTable" align="center">
			...
			<tr>
				...
				<td class="ListTableTr22">
					<s:select
							list="#@java.util.LinkedHashMap@{'xiaozuzhang':'项目小组长','zuyuan':'组员'}"
							name="proMember.role"
							theme="ufaud_simple"
				...
				<td class="ListTableTr22">
					<s:textfield  id="mobileTelephone" name="proMember.mobileTelephone" maxlength="25" />
				</td>
			</tr>
		</table>
		...
		<div align="right" style="width: 96%;">
			...
			&nbsp;&nbsp;
			<input type="button" value="取消" onclick="this.style.disabled='disabled';window.location.href='${contextPath}/project/getlistMembers!introcontrolGetlistMembers.action?crudId=${crudId}'"/>
		</div>
	</s:form>
	...
	<script type="text/javascript">
		...
		function toSave(){
			...
			var memberOutForm = document.getElementById('memberOutForm');
			if(frmCheck(memberOutForm,'projectMemberTable')==false){
