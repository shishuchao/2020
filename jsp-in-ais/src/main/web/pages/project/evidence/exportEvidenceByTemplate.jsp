...
function WebOpenPrint(){
  try{
    ...
    StatusMsg(webform.WebOffice.Status);
    window.location.href="${contextPath}/project/evidence/listEvidence.action?project_id="+"<s:property value="project_id"/>";
  }
  catch(e){
    alert(e.description);
  }
		...
		<form name="webform" method="post">
			...
			<table cellpadding=0 cellspacing=0 border=0 bordercolor="red"
				...
				<tr class="listtablehead">
					<td align="left" class="edithead" height="30">
				...
				<tr>
					<td align=right class="listtabletr11" eight="30">
						...
						<input type=button value="关闭" onclick="window.location.href='${contextPath}/project/evidence/listEvidence.action?project_id=${project_id}'"/>
					</td>
				</tr>
				<tr>
					<td height="20">
