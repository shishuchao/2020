...
<html>
	...
	<body onload="createJueDing()">
			<s:hidden id="redinggaoId" name="redinggao.fileId" />
			...
			<div id="buttonDiv" align="center">
				<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveJueDing();">保存</a>&nbsp;
	...
	<script type="text/javascript">
		...
		function createJueDing(){
			...
			try{
				WebOffice.WebUrl="<%=url_prefix%>/iweb/file"+redinggaoId+"?path=1";
				WebOffice.RecordID=redinggaoId;
				WebOffice.FileName=projectName+"审计组报告.doc";
