...
<body onload="createJueDing()">
	<s:hidden id="juedingshuId" name="juedingshu.fileId" />
	...
	<div id="buttonDiv" align="center">
			    <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveJueDing();">保存 ${jGReportName }</a>&nbsp;
...
<script type="text/javascript">
	...
	function createJueDing(){
		...
		var juedingshuId = document.getElementById('juedingshuId').value;
		var projectName = document.getElementById('projectName').value;
		var projectId = document.getElementById('projectId').value;
		try{
			WebOffice.WebUrl="<%=url_prefix%>/iweb/file"+juedingshuId+"?path=1";
			WebOffice.RecordID=juedingshuId;
			WebOffice.FileName=projectName+"审计决定书.doc";
			...
			//superWin.location.href="/ais/project/report/edit.action?recheck=recheck&project_id=${project_id}&crudId=${crudId}&taskInstanceId=${taskInstanceId}";
