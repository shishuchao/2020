...
<body onload="createshenjijureport()">
<s:hidden id="shenjijureportId" name="shenjijureport.fileId" />
...
<div id="buttonDiv" align="center">
		<a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="saveshenjijureport();">保存${jGReportName }</a>&nbsp;
...
<script type="text/javascript">
	...
	function createshenjijureport(){
		...
		var shenjijureportId = document.getElementById('shenjijureportId').value;
		var projectName = document.getElementById('projectName').value;
		var projectId = document.getElementById('projectId').value;
		try{
			WebOffice.WebUrl="<%=url_prefix%>/iweb/file"+shenjijureportId+"?path=1";
			WebOffice.RecordID=shenjijureportId;
