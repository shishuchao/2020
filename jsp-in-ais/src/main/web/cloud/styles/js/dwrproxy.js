...
;
 ...
 Ext.extend(Ext.ux.data.DwrProxy, Ext.data.DataProxy, {
 	...
 	*/	
 	dwrFunction: null, 	
 	/**	 * @cfg {String}
 loadArgsKey Defines where in the params object passed to the load method	 
 ...
 * The function must be passed <ul>	 * <li>The Record block object</li>	 
 * <li>The "arg" argument from the load function</li>	
  * <li>A boolean success indicator</li>	 
  * </ul>	 * @param {Object}scope The scope in which to call the callback	 
 ...
 for (var loadArgName in loadArgs) {
			...
			dwrFunctionArgs.push({
				...
				exceptionHandler: function(message, exception){
					// The "loadexception" event is supposed to pass the response, but since DWR doesn't provide that to us, we pass the message.					dataProxy.fireEvent("loadexception", dataProxy, message, loadCallback, exception);
