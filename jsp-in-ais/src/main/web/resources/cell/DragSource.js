...
function _dnd_handleDragStart() {
   try{
        ...
        event.dataTransfer.setData("Text", vDragText);
...
function getcurTableText(){
    ...
    value="<table><tr>"+getcurTableTdHtml(curTD)+"</tr></table>";
    if (vDebug) alert(value);
...
function getcurTableTdHtml(oTD){
    if (oTD==null) return "<td></td>";
