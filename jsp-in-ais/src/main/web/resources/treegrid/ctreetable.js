...
function cTreeTable(objName, colNum) {
 ...
 realpath="/ais/resources/treegrid/";
 this.icon ={
  root  : realpath+'folderclosed.gif',
  folder  : realpath+'folderclosed.gif ',
  folderOpen : realpath+'folderopen.gif',
  node  : realpath+'folderdoc2.gif',
  empty  : realpath+'ftv2blank.gif',
  line  : realpath+'ftv2vertline.gif',
  join  : realpath+'ftv2node.gif',
  joinBottom : realpath+'ftv2lastnode.gif',
  plus  : realpath+'ftv2pnode.gif',
  plusBottom : realpath+'ftv2plastnode.gif',
  minus  : realpath+'ftv2mnode.gif',
  minusBottom : realpath+'ftv2mlastnode.gif',
  nlPlus  : realpath+'00.gif',
  nlMinus  : realpath+'00.gif'
 };
...
*/
 ...
 this.aNodes = [];
 this.aIndent = [];
 this.root = new Node(0,-1, -2, 'root');  //root
